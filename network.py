...
class AllCNN(nn.Module):
    def __init__(self, device, last_feature_dim=10, num_classes=10):
       super().__init__()
...
class ResNet(nn.Module):
    def __init__(self, device, last_feature_dim=512, num_classes=100):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, device, last_feature_dim=768, checkpoint='google/vit-base-patch16-224-in21k', num_classes=200):
        super().__init__()
